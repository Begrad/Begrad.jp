...
const SECTION10_BODY = "未成年のユーザーが本アプリを利用する場合、保護者の同意を得たうえで利用するものとします。";
...
const TomoMemoPrivacy: React.FC = () => {
  return (
    <main className="tomo-page">
      ...
      <p className="tomo-policy-content">{INTRO}</p>

      <div className="tomo-policy-section">
        <h2>{SECTION1_TITLE}</h2>
        <p className="tomo-policy-content">{SECTION1_BODY}</p>
      </div>

      <div className="tomo-policy-section">
        <h2>{SECTION2_TITLE}</h2>
        <p className="tomo-policy-content">{SECTION2_INTRO}</p>
        <div className="tomo-policy-content">
          {SECTION2_LIST.map((line) => (
            <div key={line}>{line}</div>
          ))}
        </div>
        <p className="tomo-policy-content" style={{ marginTop: "0.9rem" }}>
          {SECTION2_ITEM2}
        </p>
        <p className="tomo-policy-content">{SECTION2_ITEM3}</p>
      </div>

      <div className="tomo-policy-section">
        <h2>{SECTION3_TITLE}</h2>
        <p className="tomo-policy-content">{SECTION3_BODY}</p>
      </div>

      <div className="tomo-policy-section">
        <h2>{SECTION4_TITLE}</h2>
        <p className="tomo-policy-content">{SECTION4_INTRO}</p>
        <div className="tomo-policy-content">
      ...
      <div className="tomo-policy-section">
        ...
        <p className="tomo-policy-content">{SECTION5_BODY1}</p>
        <p className="tomo-policy-content" style={{ marginTop: "0.9rem" }}>
          {SECTION5_BODY2}
        </p>
      </div>
      ...
      <div className="tomo-policy-section">
        ...
        <p className="tomo-policy-content">{SECTION6_BODY1}</p>
        <div className="tomo-policy-content" style={{ marginTop: "0.9rem" }}>
      ...
      <div className="tomo-policy-section">
        ...
        <p className="tomo-policy-content">{SECTION7_BODY}</p>
      </div>

      <div className="tomo-policy-section">
        <h2>{SECTION8_TITLE}</h2>
        <p className="tomo-policy-content">{SECTION8_BODY}</p>
      </div>

      <div className="tomo-policy-section">
        <h2>{SECTION9_TITLE}</h2>
        <p className="tomo-policy-content">{SECTION9_BODY}</p>
      </div>

      <div className="tomo-policy-section">
        <h2>{SECTION10_TITLE}</h2>
        <p className="tomo-policy-content">{SECTION10_BODY}</p>
      </div>

      <div className="tomo-policy-section">
        <h2>{SECTION11_TITLE}</h2>
        <p className="tomo-policy-content">{SECTION11_BODY}</p>
      </div>

      <div className="tomo-policy-section">
        <h2>{SECTION12_TITLE}</h2>
        <p className="tomo-policy-content">{SECTION12_BODY}</p>
      </div>
    </main>
  );
};
